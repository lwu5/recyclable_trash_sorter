...
class InverseKinematics:
    ...
    def do_gradient_descent(self, goal_location):
        ...
        if self.get_joint_dist(self.current_joint_angles, goal_location) <= distance_threshold:
            ...
            while self.get_joint_dist(self.current_joint_angles, goal_location) > distance_threshold:
                ...
                if self.get_joint_dist(self.current_joint_angles, goal_location) < distance_threshold:
                    ...
                    print(self.get_joint_dist(self.current_joint_angles, goal_location))
