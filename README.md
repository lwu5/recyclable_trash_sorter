...
- The integration of sensor was indeed a very adventurous experience. It was the first time I (Liuhao) was playing around hardware stuff and using Arduino IDE. A big thankyou to Jason who spent considerable amound of time going through libraries in the OpenCR package, and the knowledge I learned from this research experience was definitely beyond the scope of this class and connects myself to turtlebot 7 and the discipline at a deeper level.   
